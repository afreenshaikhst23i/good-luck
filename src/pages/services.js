                ...
                <div className="container">
                    <div className="left-fifty-wrapper">
                        ...
                        <div className="img-wrap">
                            <h2 className="service-heading">Wedding Photography</h2>
                            <img src="./images/amrin-shabbir/landscape-1.JPG" alt="Wedding Photography" className="service-img" width="518" height="345" />
                        </div>
                    </div>
                </div>
            </section>
            <section className="fifty-section service-section">
                <div className="container">
                    <div className="right-fifty-wrapper">
                        ...
                        <div className="img-wrap">
                            <h2 className="service-heading">Pre-wedding Photography</h2>
                            <img src="./images/service-pre-wedding.jpg" alt="Pre-wedding Photography" className="service-img" width="518" height="345" />
                        </div>
                    </div>
                </div>
            </section>
            <section className="fifty-section service-section">
                <div className="container">
                    <div className="left-fifty-wrapper">
                        ...
                        <div className="img-wrap">
                            <h2 className="service-heading">Product Photography</h2>
                            <img src="./images/service-product.jpg" alt="Product Photography" className="service-img" width="518" height="345" />
                        </div>
                    </div>
                </div>
            </section>
            <section className="fifty-section service-section">
                <div className="container">
                    <div className="right-fifty-wrapper">
                        ...
                        <div className="img-wrap">
                            <h2 className="service-heading">Events Photography</h2>
                            <img src="./images/service-birthday.jpg" alt="Events Photography" className="service-img" width="518" height="345" />
                        </div>
                    </div>
                </div>
            </section>
